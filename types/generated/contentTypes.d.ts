...
export interface ApiAgentAgent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vector_stores: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiChatboxChatbox extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    assistant: Schema.Attribute.Relation<'oneToOne', 'api::agent.agent'>;
    chatbox_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    first_seen: Schema.Attribute.DateTime;
    garni_cookie_value: Schema.Attribute.String;
...
export interface ApiManualManual extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    file_id: Schema.Attribute.String;
    file_name: Schema.Attribute.String;
    job_run: Schema.Attribute.Relation<'oneToOne', 'api::job-run.job-run'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::manual.manual'
    > &
      Schema.Attribute.Private;
    openai_file_id: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vector_store: Schema.Attribute.Relation<
      'manyToOne',
      'api::vector-store.vector-store'
    >;
  };
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    client_id: Schema.Attribute.Relation<'oneToOne', 'api::client.client'>;
    content: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiModelModel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    compliancetext: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
        minLength: 5;
    ...
    publishedAt: Schema.Attribute.DateTime;
    salutation: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
        minLength: 10;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    item_id: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    json_hash: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    > &
      Schema.Attribute.Private;
    product_data: Schema.Attribute.JSON & Schema.Attribute.Required;
...
export interface ApiThreadThread extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    client_satisfied: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    evaluation_detail: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::thread.thread'
...
export interface ApiVectorStoreVectorStore extends Struct.CollectionTypeSchema {
